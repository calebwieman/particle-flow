...
export default function ParticleCanvas() {
  ...
  return (
    <div className="fixed inset-0 overflow-hidden" style={{ background: '#080810' }}>
      ...
      {/* Glass Settings Panel - fully removed when closed */}
      <div className={`absolute top-0 left-0 bottom-0 w-80 z-30 overflow-hidden transition-transform duration-300 ${settingsOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div 
